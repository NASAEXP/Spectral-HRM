...
from models.layers import Attention, PoMAttention, SLAAttention, SpectreAttention
...
DEFAULT_VARIANTS = "pom-attention,pom-sla,pom-spectre"
VARIANT_SPECS = {
    "pom-attention": {
        "L_mixer": "pom",
        "H_mixer": "attention",
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Compare SLA as the H-level mixer with PoM locked on L-level.")
